    ...
    <div class="radio" class="pokemon" :class="{ selected: isSelected }">
      ...
      <label>
        ...
        <div class="details">
          ...
          <div class="hp">
            <div class="bar">
              <div class="health" :style="{ width: healthPercent }" :class="{ low: health <= 20, critical: health <= 10 }"></div>
            </div>
...
Vue.component( "List", {
  ...
  <div>
    ...
    <h1>Celebrating {{ picked }}! with Pokemon</h1>
    <h4>Here's some pokemons for you </h4>
    <div class="pokes">
    ...
    <button class="button" @click="newTeam"> Generate </button>
  </div>
`,
  data() { return {
    picked: myFunction(),
